...
class EmailWarningPopup extends StatefulWidget {
  ...
  const EmailWarningPopup({Key? key,
    this.content:'',
    this.title="",
    this.icon=false,
  ...
  @override
  State<EmailWarningPopup> createState() => _EmailWarningPopupState();
}

class _EmailWarningPopupState extends State<EmailWarningPopup> {
  @override
